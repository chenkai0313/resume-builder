...
export async function generatePDF(element: HTMLElement): Promise<Blob> {
  ...
  const watermark = '<div style="text-align:center;font-size:9px;color:#999;padding:12px 0 8px;border-top:1px solid #eee;margin-top:0">Generated by resbu.top</div>'
